...
public class ModificationAuthorisationHandlerTests : TestServiceBase<ModificationAuthorisationHandler>
{
    [Fact]
    public void EventType_ReturnsModAuth()
    {
        // Assert
        Sut.EventType.ShouldBe(NotificationTypes.ModAuth);
    }
    ...
    public async Task Handle_WhenUserIdsOrEmailsIsEmpty_DoesNotResolveEmails_AndDoesNotSendEmails()
    {
        ...
        {
            EventType = NotificationTypes.ModAuth,
