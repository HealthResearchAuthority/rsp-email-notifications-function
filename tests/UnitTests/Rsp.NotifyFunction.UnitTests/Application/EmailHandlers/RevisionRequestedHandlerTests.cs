...
public class RevisionRequestedHandlerTests : TestServiceBase<RevisionRequestedHandler>
{
    [Fact]
    public void EventType_ReturnsRevisionRequested()
    {
        // Assert
        Sut.EventType.ShouldBe(NotificationTypes.RevisionRequested);
    }
    ...
    public async Task Handle_WhenUserIdsOrEmailsIsEmpty_DoesNotResolveEmails_AndDoesNotSendEmails()
    {
        ...
        {
            EventType = NotificationTypes.RevisionRequested,
            EmailTemplateId = "template-123",
            UserIdsOrEmails = [],
            Data = JsonSerializer.SerializeToElement(new RevisionRequestedDto("Project A", "MOD-001"))
        };
    ...
    [Fact]
    public async Task Handle_WhenResolvedEmailsExist_SendsOneEmailPerRecipient_WithRevisionData()
    {
        // Arrange
        var envelope = new EmailEnvelope
        {
            ...
            Data = JsonSerializer.SerializeToElement(new RevisionRequestedDto("Cancer Study", "MOD-123"))
        };
