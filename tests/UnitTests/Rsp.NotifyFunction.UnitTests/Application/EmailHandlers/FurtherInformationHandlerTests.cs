...
public class FurtherInformationHandlerTests : TestServiceBase<FurtherInformationHandler>
{
    [Fact]
    public void EventType_ReturnsFurtherInfo()
    {
        // Assert
        Sut.EventType.ShouldBe(NotificationTypes.FurtherInfo);
    }
    ...
    public async Task Handle_WhenUserIdsOrEmailsIsEmpty_DoesNotResolveEmails_AndDoesNotSendEmails()
    {
        ...
        {
            EventType = NotificationTypes.FurtherInfo,
            EmailTemplateId = "template-123",
            UserIdsOrEmails = [],
            Data = JsonSerializer.SerializeToElement(new FurtherInformationDto("Project A", "MOD-001"))
        };
    ...
    [Fact]
    public async Task Handle_WhenResolvedEmailsExist_SendsOneEmailPerRecipient_WithAuthorisationData()
    {
        // Arrange
        var envelope = new EmailEnvelope
        {
            ...
            Data = JsonSerializer.SerializeToElement(new FurtherInformationDto("Cancer Study", "MOD-123"))
        };
