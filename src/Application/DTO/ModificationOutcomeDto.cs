...
/// <summary>
///     Represents a request to send a modification outcome email notification,
...
public record ModificationOutcomeDto(string ShortProjectTitle, string ModificationId);