...
public class NotifyFunction
{
        ...
        ServiceBusMessageActions messageActions)
    {
        ...
        sb.AppendFormat("Email successfully sent. Message Notification Type: {0}, Message Email Address: {1}, Message Template Id: {2}.", messageJson.EventName, messageJson.RecipientAddress, messageJson.EmailTemplateId);
